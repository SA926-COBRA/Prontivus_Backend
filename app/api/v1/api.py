...
from app.api.v1.endpoints import auth_db_only, patient_auth, appointments, medical_records, prescriptions, notifications, database, documents, patient_calls, financial, patients, secretary_simple, doctors, licenses, units, security, users, user_lookup, secretarial_dashboard, commercial, reports, voice, bi_analytics, advanced_emr, financial_tiss, statistical_reports, integrations
...
api_router.include_router(advanced_emr.router, prefix="/advanced-emr", tags=["advanced-emr"])
