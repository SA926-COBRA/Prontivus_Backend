...
class Patient(Base):
    ...
    # surgical_estimates = relationship("SurgicalEstimate", back_populates="patient", lazy="select")
    # surgical_contracts = relationship("SurgicalContract", back_populates="patient", lazy="select")
